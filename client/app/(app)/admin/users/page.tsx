    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-[#F8FAFC]">Utilisateurs</h1>
        </div>
        <p className="text-sm text-[#94A3B8]">Gérer les utilisateurs de la plateforme</p>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#2D3A52]">
                ...
                <th className="text-left px-6 py-4 text-xs font-medium text-[#94A3B8] uppercase tracking-wider">Courriel</th>
                <th className="text-left px-6 py-4 text-xs font-medium text-[#94A3B8] uppercase tracking-wider">Rôle</th>
                <th className="text-left px-6 py-4 text-xs font-medium text-[#94A3B8] uppercase tracking-wider">Plan</th>
                <th className="text-left px-6 py-4 text-xs font-medium text-[#94A3B8] uppercase tracking-wider">Statut</th>
              </tr>
            </thead>
                  ...
                  <tr key={u.id} className="hover:bg-[#243047]/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center gap-1 px-2 py-0.5 text-xs rounded border ${
                        ...
                        <CreditCard size={10} />
                        {u.plan === 'monthly' ? 'Mensuel' : 'Gratuit'}
                      </span>
                    </td>
                    <td className="px-6 py-4">
