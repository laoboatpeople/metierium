  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: t('pricingFeatureAiTutorLimited'), included: true },
              ...
              <div className="p-4 flex flex-col h-full">
                ...
                >
                  {currentPlan === plan.id ? (
                    ...
                    <span>{t('pricingPageDowngrade')}</span>
                  ) : (
                    plan.cta
                  )}
                </button>
      ...
      {showCancelModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-[#0A0E1A] border border-[#2D3A52] rounded-2xl p-6 w-full max-w-sm shadow-2xl text-center">
            ...
            <h3 className="text-lg font-bold text-[#F8FAFC] mb-2">{t('pricingPageCancelModalTitle')}</h3>
            <p className="text-sm text-[#94A3B8] mb-6">
              {t('pricingPageCancelModalDesc')}
            </p>
            <div className="flex gap-3">
              <button
              ...
              >
                {t('pricingPageCancelModalCancel')}
              </button>
              <button
              ...
              >
                {cancelling ? <><Loader2 size={14} className="animate-spin" /> {t('pricingPageCancelModalProcessing')}</> : t('pricingPageCancelModalConfirm')}
              </button>
            </div>
          </div>
        </div>
