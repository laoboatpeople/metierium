    ...
    <div className="min-h-screen bg-[#0A0E1A] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#F8FAFC]">{t('authForgotPassword')}</h1>
          <p className="text-sm text-[#94A3B8] mt-1">{t('authForgotPasswordDesc')}</p>
        </div>
        ...
        <div className="bg-[#1A2035] border border-[#2D3A52] rounded-xl p-6">
          {sent ? (
            <div className="text-center py-4">
              ...
              <h2 className="text-lg font-semibold text-[#F8FAFC] mb-1">{t('authEmailSent')}</h2>
              ...
              >
                <ArrowLeft size={14} /> {t('authBackToLogin')}
              </Link>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#94A3B8] mb-1">{t('email')}</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    placeholder={t('authForgotPasswordPlaceholder')}
