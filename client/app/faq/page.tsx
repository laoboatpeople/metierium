    ...
    <div className="min-h-screen bg-[#0A0E1A]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#F8FAFC]">Questions fréquentes</h1>
          <p className="text-sm text-[#94A3B8] mt-1">
            {entries.length} réponses sur les examens de métier au Québec
          </p>
        </div>
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-12">
            <p className="text-sm text-[#64748B]">Aucun résultat pour votre recherche.</p>
          </div>
        )}
      </div>
    </div>
