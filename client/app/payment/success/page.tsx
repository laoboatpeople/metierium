    ...
    <>
      {status === 'loading' && (
        <>
          ...
          <h1 className="text-xl font-bold text-[#F8FAFC] mb-2">Confirmation en cours...</h1>
          <p className="text-sm text-[#94A3B8]">Veuillez patienter pendant que nous finalisons votre abonnement.</p>
        </>
      )}
      ...
      {status === 'success' && (
        <>
          ...
          <h1 className="text-xl font-bold text-[#F8FAFC] mb-2">Paiement réussi !</h1>
          <p className="text-sm text-[#94A3B8] mb-6">
            Votre abonnement est maintenant actif. Vous avez accès à tout le contenu de votre forfait.
          </p>
          <Link
            href="/app"
      ...
      {status === 'error' && (
        <>
          ...
          <h1 className="text-xl font-bold text-[#F8FAFC] mb-2">Session invalide</h1>
          <p className="text-sm text-[#94A3B8] mb-6">
            Aucune session de paiement trouvée. Si vous avez déjà payé, votre abonnement sera activé sous peu.
          </p>
          <Link
            href="/app"
