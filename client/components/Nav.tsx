        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-white/5 bg-[#0A0E1A]/95 backdrop-blur-md">
            <div className="px-6 py-4 space-y-3">
              ...
              <Link href="/faq" className="block text-sm text-[#94A3B8] hover:text-white" onClick={() => setMobileMenuOpen(false)}>{t('navFaq')}</Link>
              <Link href="/blog" className="block text-sm text-[#94A3B8] hover:text-white" onClick={() => setMobileMenuOpen(false)}>{t('navBlog')}</Link>
              <Link href="/contact" className="block text-sm text-[#94A3B8] hover:text-white" onClick={() => setMobileMenuOpen(false)}>{t('navContact')}</Link>
